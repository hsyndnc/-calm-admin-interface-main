  ...
  return (
    <CustomerLayout>
      <div className="max-w-3xl mx-auto px-4 py-6">
        <h1 className="text-xl font-semibold mb-6">Sepetim</h1>

        {items.length === 0 ? (
          <div className="text-center py-16">
            <ShoppingBag className="w-16 h-16 text-muted-foreground mx-auto mb-4" />
            <h2 className="text-lg font-semibold mb-2">Sepetiniz boş</h2>
            <p className="text-muted-foreground mb-6">Alışverişe başlamak için ürünler sayfasına gidin.</p>
            <Button onClick={() => navigate("/customer/products")}>Ürünlere Git</Button>
          </div>
        ) : (
